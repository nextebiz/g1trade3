...
import { CheckOutlined, CloseCircleOutlined, RightOutlined, UploadOutlined } from "@ant-design/icons"
...
export default function UploadNewProduct() {
  ...
  const onFinish = async (values: any) => {
    ...
    const create_product = await fetch("/api/seller/products/create", { method: "post", body: formData })
    ...
    <div className='' style={{ width: "100%" }}>
      ...
      <div className='text-black py-6 pl-3 pr-3 sm:pl-8  '>
        <section className='mb-10 '>
          ...
          {page_loaded ? <div className='mt-8  ' style={{ width: "100%" }} >
            <Form
              name="basic"
              wrapperCol={{ span: 16 }}
              style={{ maxWidth: "100%" }}
